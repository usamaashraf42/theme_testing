...
trigger:function(e,i){t(this).triggerHandler(e,i)},
updateNote:function(t){return this._promiseChange({url:"/cart/update.js",dataType:"json",data:{note:t||""}})},
addItem:function(t,e){
  return this._promiseChange({
    url:"/cart/add.js",dataType:"json",data:{id:t,quantity:void 0===e?1:e}
  }
  )
}, 
addItemFromForm:function(t){return this._promiseChange({url:"/cart/add.js",dataType:"json",processData:!1,contentType:!1,type:"POST",data:t})},
removeItem:function(t){return this._promiseChange({url:"/cart/change.js",dataType:"json",data:{line:t,quantity:0}})},
changeItem:function(t,e){return this._promiseChange({url:"/cart/change.js",dataType:"json",data:{line:t,quantity:e}})},
saveLocalState:function(t){return E.isLocalStorageSupported()&&(localStorage.shopify_cart_state=JSON.stringify(t)),t},
getLocalState:function(){if(E.isLocalStorageSupported())return JSON.parse(localStorage.shopify_cart_state||"")},_promiseChange:function(e){var i=t.ajax(e);return this.isUpdating=!0,navigator&&!theme.isOnline&&(i=t.Deferred().reject()),i.then(function(t){return void 0===t.token?this.getCart():t}.bind(this)).then(this.saveLocalState).then(this._triggerChangeEvent.bind(this)).catch(this._triggerErrorEvent.bind(this)).always(function(){this.isUpdating=!1}.bind(this))},_triggerChangeEvent:function(t){return this.trigger("change",t),t},_triggerErrorEvent:function(t){throw this.trigger("error",t),t}},G={formatMoney:function(t,e){function i(t,e,i,n){if(e=h(e,2),i=h(i,","),n=h(n,"."),isNaN(t)||null===t)return 0;t=(t/100).toFixed(e);var s=t.split(".");return s[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1"+i)+(s[1]?n+s[1]:"")}"string"==typeof t&&(t=t.replace(".",""));var n="",s=/\{\{\s*(\w+)\s*\}\}/,o=e||"${{amount}}";switch(o.match(s)[1]){case"amount":n=i(t,2);break;case"amount_no_decimals":n=i(t,0);break;case"amount_with_comma_separator":n=i(t,2,".",",");break;case"amount_no_decimals_with_comma_separator":n=i(t,0,".",",");break;case"amount_no_decimals_with_space_separator":n=i(t,0," ");break;case"amount_with_apostrophe_separator":n=i(t,2,"'")}return o.replace(s,n)}},J={preload:function(t,e){"string"==typeof t&&(t=[t]);for(var i=0;i<t.length;i++){var n=t[i];this.loadImage(this.getSizedImageUrl(n,e))}},loadImage:function(t){(new Image).src=t},switchImage:function(t,e,i){var n=this.imageSize(e.src),s=this.getSizedImageUrl(t.src,n);i?i(s,t,e):e.src=s},imageSize:function(t){t=t||"";var e=t.match(/.+_((?:pico|icon|thumb|small|compact|medium|large|grande)|\d{1,4}x\d{0,4}|x\d{1,4})[_\\.@]/);return null!==e?e[1]:null},getSizedImageUrl:function(t,e){if(null===e)return t;if("master"===e)return this.removeProtocol(t);var i=t.match(/\.(jpg|jpeg|gif|png|bmp|bitmap|tiff|tif)(\?v=\d+)?$/i);if(null!==i){var n=t.split(i[0]),s=i[0];return this.removeProtocol(n[0]+"_"+e+s)}return null},removeProtocol:function(t){return t.replace(/http(s)?:/,"")}},Z={itemId:"data-cart-item-id",itemLineNumber:"data-cart-item-line-number"},tt={ajaxCart:".cart-drawer",itemList:"[data-cart-item-list]",item:"[data-cart-item]",itemId:"[data-cart-item-id]",itemHref:"[data-cart-item-href]",itemImage:"[data-cart-item-image]",itemBackgroundImage:"[data-cart-item-background-image]",itemTitle:"[data-cart-item-title]",
itemVariantTitle:"[data-cart-item-variant-title]",
itemDetailsList:"[data-cart-item-details-list]",itemProperty:"[data-cart-item-property]",itemSellingPlanName:"[data-cart-item-selling-plan-name]",
itemDiscountList:"[data-cart-item-discount-list]",itemDiscount:"[data-cart-item-discount]",itemDiscountTitle:"[data-cart-item-discount-title]",
itemDiscountAmount:"[data-cart-item-discount-amount]",itemLabelQuantity:"[data-cart-item-label-quantity]",
itemInputQuantity:"[data-cart-item-input-quantity]",
itemDelete:"[data-cart-item-delete]",itemPriceContainer:"[data-cart-item-price-container]",itemLinePriceContainer:"[data-cart-item-line-price-container]",
itemMessage:"[data-item-message]",cartDiscountContainer:"[data-cart-discount-container]",cartDiscount:"[data-cart-discount]",cartDiscountTitle:"[data-cart-discount-title]",
cartDiscountAmount:"[data-cart-discount-amount]",cartNoteContainer:"[data-cart-note-container]",cartNoteInput:"[data-cart-note]",
cartMessage:"[data-cart-message]",cartSubtotal:"[data-cart-subtotal]",cartSubmit:"[data-cart-submit]"},
et={cartTemplate:"ajax-cart__template",cartItemRemove:"ajax-cart__item--remove",cartError:"ajax-cart--error",
visuallyHidden:"visually-hidden",cartDiscountActive:"ajax-cart__discount-container--active",btnLoaderActive:"btn--loader-active"},
it={init:function(){this.$ajaxCart=t(tt.ajaxCart,this.$container),this.$itemTemplate=t(tt.item,this.$container).first().clone(),this.$propertyTemplate=t(tt.itemProperty,this.$container).first().clone(),this.$sellingPlanNameTemplate=t(tt.itemSellingPlanName,this.$container).first().clone(),this.$discountTemplate=t(tt.itemDiscount,this.$container).first().clone(),this.$cartDiscountTemplate=t(tt.cartDiscount,this.$container).first().clone(),Y.on("quantity",this._onQuantityError.bind(this)),Y.on("change",function(t,e){this.update(e)}.bind(this)),
...
s.attr("aria-hidden",!0),o.attr("aria-hidden",!1),
